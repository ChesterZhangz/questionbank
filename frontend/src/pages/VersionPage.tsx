        ...
        >
          <Card className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white border-0 shadow-2xl">
            <div className="p-8 text-center">
              ...
              <h2 className="text-2xl font-bold mb-2">当前版本 v0.73</h2>
              <p className="text-blue-100 text-lg mb-4">图片上传持久化系统重构：临时存储转换、QuestionView优化、React渲染稳定性提升</p>
              <p className="text-blue-200">
                重构图片上传持久化系统，实现临时图片到永久存储的自动转换，优化QuestionView中图片与图形的合并显示，修复React key重复导致的渲染问题！
              </p>
            </div>
          </Card>
        </motion.div>
