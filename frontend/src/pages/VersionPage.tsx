        ...
        >
          <Card className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white border-0 shadow-2xl">
            <div className="p-8 text-center">
              ...
              <h2 className="text-2xl font-bold mb-2">当前版本 v0.72</h2>
              <p className="text-blue-100 text-lg mb-4">TikZ渲染系统全面优化：分数渲染增强、虚线样式支持、箭头颜色适配、透明度控制</p>
              <p className="text-blue-200">
                深度优化TikZ渲染引擎，完善分数渲染系统，新增虚线样式支持，实现箭头颜色自动匹配，添加透明度控制！
              </p>
            </div>
          </Card>
        </motion.div>
