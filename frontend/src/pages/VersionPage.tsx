        ...
        >
          <Card className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white border-0 shadow-2xl">
            <div className="p-8 text-center">
              ...
              <p className="text-blue-100 text-lg mb-4">系统全面优化升级：QuestionView动画系统、LaTeX编辑器、题目管理、企业消息功能完善</p>
              <p className="text-blue-200">
                全面优化QuestionView组件的动画系统，采用简约破碎感设计理念，大幅提升动画速度，优化用户体验，实现快速响应的界面交互效果！同时完善LaTeX编辑器功能，增强题目管理系统，优化企业消息系统，全面提升系统稳定性和用户体验！
              </p>
            </div>
          </Card>
        </motion.div>
