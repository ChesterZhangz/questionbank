...
const BatchUploadPage: React.FC = () => {
  ...
  const processPDFFile = async (document: DocumentItem, formData: FormData) => {
    ...
    try {
      ...
      const response = await fetch('/api/mathpix-optimized/process-pdf-optimized', {
        method: 'POST',
        headers: {
  ...
  const processWordFile = async (document: DocumentItem, formData: FormData) => {
    ...
    try {
      ...
      const response = await fetch('/api/mathpix-optimized/process-word-optimized', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`
        },
  ...
  const processTeXFile = async (document: DocumentItem, formData: FormData) => {
    ...
    try {
      ...
      const response = await fetch('/api/mathpix-optimized/process-tex', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`
        },
    ...
    showConfirm(
      ...
      try {
        ...
        if (isProcessing) {
          ...
          // 发送取消请求到后端
          try {
            await fetch(`/api/document-parser/cancel/${docId}`, {
              method: 'POST',
              headers: {
                'Authorization': `Bearer ${token}`,
