          ...
          <div className="flex items-center space-x-3 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              <div className="group relative">
                ...
                {/* 悬停显示完整文件名 */}
                <div className="absolute bottom-full left-0 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-[9999] max-w-xs break-words">
                  {document.fileName}
