              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    style={{
                      color: localSettings.mathDifficulty === option.value ? option.textColor : document.documentElement.classList.contains('dark') ? '#d1d5db' : '#4b5563'
                    }}
                  >
                    {option.label}
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    ...
                    className="text-sm font-medium"
                    style={{
                      color: localSettings.memoryGridSize === size ? '#065f46' : document.documentElement.classList.contains('dark') ? '#d1d5db' : '#4b5563'
                    }}
                  >
                    {size}×{size}
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    ...
                    className="text-sm font-medium"
                    style={{
                      color: localSettings.puzzleGridSize === size ? '#5b21b6' : document.documentElement.classList.contains('dark') ? '#d1d5db' : '#4b5563'
                    }}
                  >
                    {size}×{size}
                  </div>
                    ...
                    {[
                      ...
                      >
                        <div 
                          className="text-sm font-medium"
                          style={{
                            color: localSettings.reactionDifficulty === option.value ? option.textColor : document.documentElement.classList.contains('dark') ? '#d1d5db' : '#4b5563'
                          }}
                        >
                          {option.label}
                        </div>
                        <div 
                          className="text-xs"
                          style={{
                            color: localSettings.reactionDifficulty === option.value ? option.textColor.replace('1b', '47') : document.documentElement.classList.contains('dark') ? '#9ca3af' : '#6b7280'
                          }}
                        >
                          {option.desc}
                        </div>
