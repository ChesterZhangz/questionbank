...
|----------|------------------|-------------------------------|--------------------------------|----------------------------------------------------------------------------|
| ★☆☆☆☆ (1星) | 0.8以上         | 基础题（如选择题前5题）       | 记忆、直接应用                 | 单一知识点，直接套用公式或概念，计算量极小         |
| ★★☆☆☆ (2星) | 0.6-0.8         | 中低档题（填空、常规解答）    | 理解、简单推理                 | 1-2个知识点组合，需基础变换或步骤推导，计算量中等   |
| ★★★☆☆ (3星) | 0.4-0.6         | 中档题（综合解答题）          | 分析、综合应用                 | 多知识点交叉，需构建模型或抽象转化，含隐含条件，计算量较大 |
| ★★★★☆ (4星) | 0.2-0.4         | 难题（压轴题前部）            | 评价、复杂推理                 | 综合性强，需创新解法（如分类讨论、构造技巧），计算复杂易出错 |
| ★★★★★ (5星) | 0.2以下         | 极难题（压轴题最后一问）      | 创造、批判性思维               | 超纲思维或高等数学背景，步骤冗余度高，区分顶尖学生 |
