...
# 确保图标文件被复制
COPY --from=frontend-builder --chown=nextjs:nodejs /app/frontend/src/public ./frontend/public
# 复制静态文件到nginx可访问的位置
COPY --from=frontend-builder --chown=nextjs:nodejs /app/frontend/src/public ./static
